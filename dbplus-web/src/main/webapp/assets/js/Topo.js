    ...
    obj.addEventListener("click", function(){
        ...
        for(var i = 0;i < nodeArr.length;i++){
            if(nodeArr[i].nodeA == obj||nodeArr[i].nodeZ == obj){
                ...
                nodeArr[i].link.drawanimepic("./img/jiantouc.png",scene);
                ...
                nodeArr[i].link.drawanimepic("./img/jiantou.png",scene);
...
function linkCheck(obj,link){
    if(obj){
        link.drawanimepic("./img/jiantoucheck.png",scene);
        link.strokeColor="202,79,75";
        link.fontColor = "202,79,75";
    }else{
        link.drawanimepic("./img/jiantou.png",scene);
...
if($("body").attr("data-frame")=="newFrame"){
    ...
    link9.drawanimepic("./img/jiantou.png",scene);
    link9.strokeColor="102,102,102";
    var link7 = linkNode(node8,node7,'777',false);
    link7.drawanimepic("./img/jiantou.png",scene);
